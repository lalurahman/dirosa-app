        ...
        <div class="col s12 m8 l8">
            ...
            <div class="card teal">
                <div class="card-content white-text">
                    <span class="card-title">Pertemuan Ke - 1</span>
                    <iframe src="https://www.youtube.com/watch?v=l9E3EvMBmKQ" width="100%" height="300px" frameborder="0" class="mb-2"></iframe>
                    <p class="mb-2">Silahkan baca gambar dibawah ini!</p>
                    <img class="mb-2" src="<?= base_url('assets/template/img/dirosa.jpg') ?>" width="100%">
            ...
            <div class="card blue-grey darken-1">
                <div class="card-content white-text">
                    ...
                    <ul>
                        ...
                        <li>
                            <h5><a style="color: currentColor;opacity: 0.5;text-decoration: none;" class="white-text" href="">Pertemuan 2</a></h5>
                        </li>
                        <li>
